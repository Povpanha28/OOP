...
public class ProductDemo {
    ...
    public static void main(String[] args) {
        ...
        DiscountProduct discountProduct = new DiscountProduct(null, 50, 2, null, null, null, 50, "admin123");
        // Store the objects in an array of type Product
        Product[] products = new Product[4];
        products[0] = shirt;
        products[1] = shoes;
        products[2] = pant;
        products[3] = discountProduct;
        ...
        DiscountProduct discountFromArray = (DiscountProduct) products[3];
        System.out.println("Discount percentage: " + discountFromArray.getDiscountPercentage());
    }
}
